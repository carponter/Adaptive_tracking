...
def add_ext_eval_args(parser: ArgumentParser):
    ...
    parser.add_argument('--GROUNDING_DINO_CONFIG_PATH',
                        default='/nfs/dataset/code/Offline_RL_Active_Tracking/Tracking-Anything-with-DEVA/saves/GroundingDINO_SwinT_OGC.py')

    parser.add_argument('--GROUNDING_DINO_CHECKPOINT_PATH',
                        default='/nfs/dataset/code/Offline_RL_Active_Tracking/Tracking-Anything-with-DEVA/saves/groundingdino_swint_ogc.pth')
    ...
    parser.add_argument('--SAM_CHECKPOINT_PATH', default='/nfs/dataset/code/Offline_RL_Active_Tracking/Tracking-Anything-with-DEVA/saves/sam_vit_h_4b8939.pth')
